...
def auth(request):
    ...
    scope = urlencode("https://www.googleapis.com/auth/calendar+https://www.googleapis.com/auth/plus.me+https://www.googleapis.com/auth/tasks+https://www.googleapis.com/auth/userinfo.profile")
